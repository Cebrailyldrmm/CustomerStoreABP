...
namespace Acme.CustomerStore.Web.Menus;

public class CustomerStoreMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public CustomerStoreMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<CustomerStoreResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                CustomerStoreMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
